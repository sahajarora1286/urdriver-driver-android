package com.sahajarora.urdriver.urdriver_driver.helper;
...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_DRIVING_EXP = "drivingExperience";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                + KEY_PHONE + " TEXT," + KEY_UID + " LONG," + KEY_LICENSE_NUMBER + " TEXT," + KEY_DRIVING_EXP
                + " INTEGER" + ");";
     ...
     * */
    public void addDriver(String name, String email, String address, String postalCode, String phone, Long uId, String licenseNumber,
        ...
        values.put(KEY_LICENSE_NUMBER, licenseNumber);
        values.put(KEY_DRIVING_EXP, drivingExperience);
    ...
    public HashMap<String, String> getDriverDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            driver.put("email", cursor.getString(2));
            driver.put("address", cursor.getString(3));
            driver.put("postalCode", cursor.getString(4));
            driver.put("phone", cursor.getString(5));
            driver.put("uId", cursor.getString(6));
            driver.put("licenseNumber", cursor.getString(7));
            driver.put("drivingExperience", cursor.getString(8));
